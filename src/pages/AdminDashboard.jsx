  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      ...
      {showModal && selectedPartner && (
        <div className="bg-gray-100 fixed inset-0 bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-md max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-900 bg-gray-200 p-3 rounded-lg">{selectedPartner.message}</p>
              </div>
            ...
            <div className="p-4 border-t border-gray-200 bg-gray-50 rounded-b-xl">
              <div className="flex flex-wrap gap-10 justify-end">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 text-gray-700 border border-gray-400 rounded-lg  hover:bg-green-100"
                >
                  <CheckCircle className="w-5 h-5" style={{color:"green"}} /> Approve
                </button>
