...
//               <i className="ri-money-rupee-circle-fill"></i>{product.offerPrice * product.quantity}
//             </p>
//             <button
...
//             <span>Price</span>
//             <span><i className="ri-money-rupee-circle-fill"></i>{totalCartAmount()}</span>
//           </p>
//           <p className="flex justify-between">
...
//           <p className="flex justify-between">
//             <span>Tax (2%)</span>
//             <span><i className="ri-money-rupee-circle-fill"></i>{(totalCartAmount() * 2) / 100}</span>
//           </p>
//           <p className="flex justify-between text-lg font-medium mt-3">
//             <span>Total Amount:</span>
//             <span><i className="ri-money-rupee-circle-fill" ></i>{totalCartAmount() + (totalCartAmount() * 2) / 100}</span>
//           </p>
//         </div>
