          ...
          <div className="flex justify-center gap-8 mb-8">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <path d="M19 3A2 2 0 0121 5v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2-2h14zM8.34 18v-7.34H5.67V18h2.67zm-1.33-8.5c.86 0 1.56-.7 1.56-1.56S7.87 6.38 7.01 6.38 5.45 7.08 5.45 7.94s.7 1.56 1.56 1.56zm11 8.5v-4.07c0-2.43-1.3-3.56-3.03-3.56-1.4 0-2.04.77-2.4 1.32v-1.51H8.57V18h2.67v-3.67c0-.98.17-1.91 1.39-1.91 1.19 0 1.2 1.15 1.2 1.99V18h2.67z" />
              </svg>
            </a>
            <a
