...
const supportLinks = [
  { name: "Accessibility", path: "/access-ability" },
  { name: "ContactUs", path: "/Contactus" },
  { name: "Help Center", path: "/Help-center" },
  { name: "FAQ's", path: "/Faqs" },
];
        ...
        <div className="bg-white/55 dark:bg-gray-100 rounded-3xl p-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 text-gray-900">
            ...
            <div className="w-full text-center lg:text-left transition-all duration-500 hover:scale-111 bg-white/55 rounded-xl shadow-lg">
              ...
              <p className="mt-4 text-sm px-9 mb-5 dark:text-gray-900">
                <i className="ri-account-circle-line"> Stay as long as you love freshness.</i>
              </p>
            </div>
            ...
            <div className="w-full text-center lg:text-left transition-all duration-500 hover:scale-111 bg-white/55 px-2 rounded-xl shadow-lg">
              ...
              <ul className="mt-4 flex flex-col gap-3 lg:text-left px-10 text-base">
                {companyLinks.map(({ name, path }) => (
                  <li key={name}>
                    <Link to={path} className="hover:text-pink-700 transition-colors">{name}</Link>
                  </li>
                ))}
              </ul>
              <p className="mt-4.5 text-sm px-7 mb-2 dark:text-gray-900">
                <i className="ri-account-circle-line"> Service running. Your choice always.</i>
              </p>
            </div>
            ...
            <div className="w-full text-center lg:text-left transition-all duration-500 hover:scale-111 bg-white/55 px-2 rounded-xl shadow-lg">
              ...
              <p className="mt-13 text-sm px-7 text-gray-500 text-wrap-reverse dark:text-gray-900">
                <i className="ri-account-circle-line"> Your issue, our priority. Contact freely.</i>
              </p>
            </div>
            ...
            <div className="w-full text-center lg:text-left transition-all duration-500 hover:scale-111 bg-white/55 px-2 rounded-xl wrap-break-word shadow-lg hover:shadow-x">
              ...
              <p className="mt-4 text-sm px-5 mb-5 text-gray-500 dark:text-gray-900">
                <i className="ri-account-circle-line"> We respect your privacy. Unsubscribe anytime.</i>
              </p>
            </div>
          </div>
          ...
          {/* Footer Bottom */}
          <hr className="border-gray-500 dark:border-gray-300 mt-10" />
          <div className="flex flex-col md:flex-row gap-2 items-center justify-between py-3 text-sm text-gray-900">
            <p>
              <i className="ri-focus-2-fill"></i>{new Date().getFullYear()} Fresh Basket. All rights reserved.
            </p>
            <Link 
                to="https://github.com/rohitvishwakrma" 
              target="_blank" 
